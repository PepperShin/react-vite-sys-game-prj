...
const BoardPagingPage = () => {
    ...
    const getContacts = async (pageNum = 1) => {
        await axios
            ...
            .then((response) => {
                ...
                // 위에 객체 형식으로 넣을 수 있으나, 화살표 함수 사용 안할 시에 변환이 느림
                setPaging((prev) => ({
                    // prev는 useState의 callback 함수에서 paging의 전 값을 불러온다.
                    ...prev,
    ...
    //<button className='btn btn-success' value={contact.no} onClick={deleteBoard}>삭제</button>
